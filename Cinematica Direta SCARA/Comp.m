...
SerialLinkResponseA = l.fkine([0 0 0 0]);
SerialLinkResponseB = l.fkine([pi/2 -pi/2 0 0]);
SerialLinkResponseC = l.fkine([pi/2 -pi/2 0 0.05]);

MyResponseA = Fkine(0,0,0,0);
MyResponseB = Fkine(pi/2,-pi/2,0,0);
MyResponseC = Fkine(pi/2,-pi/2,0,0.05);
